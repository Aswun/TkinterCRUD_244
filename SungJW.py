...
def create_database():
    # Membuat file database 'nilai_siswa.db' jika belum ada
    # dan membuat tabel 'nilai_siswa' untuk menyimpan data siswa dan prediksi fakultas
...
# Fungsi untuk memperbarui data di tabel 'nilai_siswa' berdasarkan ID
...
# Fungsi untuk menghapus data dari tabel 'nilai_siswa' berdasarkan ID
...
def calculate_prediction(biologi, fisika, inggris):
    # Mengembalikan fakultas berdasarkan nilai tertinggi di antara biologi, fisika, dan Inggris
...
# Fungsi untuk menangani input data dari pengguna dan menyimpan ke database
def submit():
    try:
        nama = nama_var.get()
...
# Fungsi untuk memperbarui data siswa yang dipilih di tabel
def update():
    try:
...
# Fungsi untuk menghapus data siswa yang dipilih di tabel
def delete():
    try:
        if not selected_record_id.get():
...
# Fungsi untuk mengosongkan input pengguna
def clear_inputs():
    nama_var.set("")
    biologi_var.set("")
    fisika_var.set("")
